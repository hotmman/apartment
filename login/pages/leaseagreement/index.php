...
?>
        ...
        <div id="page-wrapper">
            <div class="row">
                ...
                <form action="pdf.php">
                <div class="form-group row animated slideInUp">
                ...
                <div class="col-xs-1">
                    ...
                    <input class="form-control" id="ex2" type="text" name="t_name" required>
                  </div>

                  <div class="col-xs-3">
                    <label for="ex3">ชื่อ</label>
                    <input class="form-control" id="ex3" type="text" name="name" required>
                  </div>

                  <div class="col-xs-3">
                    <label for="ex3">นามสกุล</label>
                    <input class="form-control" id="ex3" type="text" name="l_name" required>
                  </div>
                </div>
                ...
                <label for="ex3">บ้านเลขที่</label>
                    <input class="form-control" id="ex3" type="text" name="a_1" required>
                </div>
                <div class="col-xs-1">
                <label for="ex3">หมู่ที่</label>
                    <input class="form-control" id="ex3" type="text" name="a_2" required>
                </div>
                <div class="col-xs-2">
                <label for="ex3">ถนน</label>
                    <input class="form-control" id="ex3" type="text" name="a_3" required>
                </div>
                <div class="col-xs-3">
                <label for="ex3">แขวง/ตำบล</label>
                    <input class="form-control" id="ex3" type="text" name="a_4" required>
                </div>
                <div class="col-xs-3">
                <label for="ex3">เขต/อำเภอ</label>
                    <input class="form-control" id="ex3" type="text" name="a_5" required>
                </div>
                <div class="col-xs-2">
                <label for="ex3">จังหวัด</label>
                    <input class="form-control" id="ex3" type="text" name="a_6" required>
                </div>
                </div>
