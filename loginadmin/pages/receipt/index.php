...
?>
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Make Receipt<?php for ($i=0; $i <20 ; $i++) { echo'&#160';}echo $thaimonth[date('m')-1]; ?></h1>
                </div>
                ...
                for ($i=0; $i < 26; $i++) { 
                  ...
                  if ($result->num_rows > 0) {
                    ...
                    <h1 class='text-center'>".$room[$i]."</h1>
                      ...
                      <input class='form-control' id='ex2' type='text' name='p_room_".$room[$i]."' value='$roomrate'>
                      </div>
                      <div class='col-xs-1'>
                        <label for='ex2'>Internet</label>
                        <input class='form-control' id='ex2' type='text' name='net_room_".$room[$i]."' value='$net'>
                      </div>
                      <div class='col-xs-1'>
                        <label for='ex2'>ยูนิตน้ำ</label>
                        <input class='form-control' id='ex2' type='text' name='w_room_".$room[$i]."' value='$waterunit'>
                      </div>
                      <div class='col-xs-1'>
                        <label for='ex2'>ยูนิตไฟ</label>
                        <input class='form-control' id='ex2' type='text' name='e_room_".$room[$i]."' value='$electricityunit'>
                    </div>
                    </div>";
                    if($i ==13){
